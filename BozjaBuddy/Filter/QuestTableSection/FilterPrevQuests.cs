...
{
    internal class FilterPrevQuests : Filter
    {
        public override string mFilterName { get; set; } = "Prev";
        protected Dictionary<int, Tuple<string, bool>?> _cacheRes = new();

        public FilterPrevQuests() { }

        public FilterPrevQuests(bool pIsFilteringActive, Plugin? pPlugin = null, bool isSortingActive = false)
        {
            Init();
        ...
        public override bool CanPassFilter(Quest pQuest)
        {
            ...
            foreach (int iID in pQuest.mPrevQuestIds)
            {
